...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://ashgalleri.com/hero-bg.jpg',
        width: 1200,
        height: 630,
  ...
  return (
    <html lang="ms" className="scroll-smooth">
      <body className={inter.className}>
        ...
        >
          {/* IKON RASMI WHATSAPP */}
          <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="group-hover:animate-pulse">
